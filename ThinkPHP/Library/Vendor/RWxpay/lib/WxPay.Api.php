...
//			print_r(dirname(dirname(__FILE__)).$sslCertPath);
			curl_setopt($ch,CURLOPT_SSLCERTTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLCERT, dirname(dirname(__FILE__)).$sslCertPath);
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, dirname(dirname(__FILE__)).$sslKeyPath);
		}
		//post提交方式
