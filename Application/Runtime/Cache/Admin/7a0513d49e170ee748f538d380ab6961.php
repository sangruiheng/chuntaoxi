...
<script type="text/javascript" src="/Public/ht/js/jquery.js"></script>
<script type="text/javascript" src="/Public/ht/js/action.js"></script>
</head>
<body>
         ...
         <!-- 遍历 -->
          <?php if(is_array($productlist)): $i = 0; $__LIST__ = $productlist;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr data-id="<?php echo ($v["id"]); ?>" data-photo="<?php echo ($v["photo_x"]); ?>">
             ...
             <td style="padding:8px;">
              <img src="/Data/<?php echo ($v["photo_x"]); ?>" width="60px;" height="60px;" />
             </td>
