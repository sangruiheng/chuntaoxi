...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 数据统计 <span class="c-gray en">&gt;</span> 销售数据趋势 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<div class="page-container">
    ...
    <div class="aaa_pts_show_2">
        <div class="">
            ...
            <input class="btn btn-success" type="button" value="日统计" style="margin-left: 20px;" onclick="location='<?php echo U('order_count');?>?shop_id=<?php echo $shop_id ?>&type=d'">
            <input class="btn btn-success" type="button" value="月统计" style="margin-left: 20px;" onclick="location='<?php echo U('order_count');?>?shop_id=<?php echo $shop_id ?>&type=m'">
