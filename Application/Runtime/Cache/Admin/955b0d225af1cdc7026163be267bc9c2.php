...
<div class="page-container">
    ...
    <div>
        <div class="ord_show_5">
            ...
            发货快递：
            <select class="inp_1" name="kuaidi_name" id="kuaidi_name" style="width:150px;margin-right:5px;">
                <!-- 遍历 -->
                <option value="">选择快递</option>
                <?php if(is_array($post_infos)): $i = 0; $__LIST__ = $post_infos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["name"]); ?>" <?php if($v["id"] == $order_info['post']): ?>selected="selected"<?php endif; ?>>-- <?php echo ($v["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                <!-- 遍历 -->
            </select>

            <!--<input id="kuaidi_name" value="<?php echo $order_info['kuaidi_name'];?>" />-->
            <br>
